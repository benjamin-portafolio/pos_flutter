...
class $RecipeComponentsTable extends RecipeComponents
    with TableInfo<$RecipeComponentsTable, RecipeComponentRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $RecipeComponentsTable(this.attachedDatabase, [this._alias]);
  ...
  static const VerificationMeta _quantityAtomicMeta = const VerificationMeta(
    'quantityAtomic',
  );
  @override
  late final GeneratedColumn<int> quantityAtomic = GeneratedColumn<int>(
    'quantity_atomic',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'recipe_components';
  @override
  VerificationContext validateIntegrity(
    Insertable<RecipeComponentRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('quantity_atomic')) {
      context.handle(
        _quantityAtomicMeta,
        quantityAtomic.isAcceptableOrUnknown(
          data['quantity_atomic']!,
          _quantityAtomicMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_quantityAtomicMeta);
    }
    return context;
  }

  @override
  Set<GeneratedColumn> get $primaryKey => {variantId, inventoryItemId};
  @override
  RecipeComponentRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return RecipeComponentRow(
      ...
      quantityAtomic: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}quantity_atomic'],
      )!,
    );
  }

  @override
  $RecipeComponentsTable createAlias(String alias) {
    return $RecipeComponentsTable(attachedDatabase, alias);
  }
}
...
class RecipeComponentRow extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['inventory_item_id'] = Variable<String>(inventoryItemId);
    map['quantity_atomic'] = Variable<int>(quantityAtomic);
    return map;
  }

  RecipeComponentsCompanion toCompanion(bool nullToAbsent) {
    return RecipeComponentsCompanion(
  ...
  factory RecipeComponentRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return RecipeComponentRow(
      ...
      inventoryItemId: serializer.fromJson<String>(json['inventoryItemId']),
      quantityAtomic: serializer.fromJson<int>(json['quantityAtomic']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'inventoryItemId': serializer.toJson<String>(inventoryItemId),
      'quantityAtomic': serializer.toJson<int>(quantityAtomic),
    };
  }

  RecipeComponentRow copyWith({
    String? variantId,
    ...
    inventoryItemId: inventoryItemId ?? this.inventoryItemId,
    quantityAtomic: quantityAtomic ?? this.quantityAtomic,
  );
  RecipeComponentRow copyWithCompanion(RecipeComponentsCompanion data) {
    return RecipeComponentRow(
      variantId: data.variantId.present ? data.variantId.value : this.variantId,
      inventoryItemId: data.inventoryItemId.present
          ? data.inventoryItemId.value
          : this.inventoryItemId,
      quantityAtomic: data.quantityAtomic.present
          ? data.quantityAtomic.value
          : this.quantityAtomic,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('RecipeComponentRow(')
  ...
  @override
  int get hashCode => Object.hash(variantId, inventoryItemId, quantityAtomic);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is RecipeComponentRow &&
          other.variantId == this.variantId &&
          other.inventoryItemId == this.inventoryItemId &&
          other.quantityAtomic == this.quantityAtomic);
}

class RecipeComponentsCompanion extends UpdateCompanion<RecipeComponentRow> {
  final Value<String> variantId;
  final Value<String> inventoryItemId;
  final Value<int> quantityAtomic;
  final Value<int> rowid;
  const RecipeComponentsCompanion({
    this.variantId = const Value.absent(),
    this.inventoryItemId = const Value.absent(),
    this.quantityAtomic = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  RecipeComponentsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       inventoryItemId = Value(inventoryItemId),
       quantityAtomic = Value(quantityAtomic);
  static Insertable<RecipeComponentRow> custom({
    Expression<String>? variantId,
    Expression<String>? inventoryItemId,
    Expression<int>? quantityAtomic,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (variantId != null) 'variant_id': variantId,
      if (inventoryItemId != null) 'inventory_item_id': inventoryItemId,
      if (quantityAtomic != null) 'quantity_atomic': quantityAtomic,
      if (rowid != null) 'rowid': rowid,
    });
  }

  RecipeComponentsCompanion copyWith({
    Value<String>? variantId,
    Value<String>? inventoryItemId,
    Value<int>? quantityAtomic,
    Value<int>? rowid,
  }) {
    return RecipeComponentsCompanion(
      variantId: variantId ?? this.variantId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (quantityAtomic.present) {
      map['quantity_atomic'] = Variable<int>(quantityAtomic.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('RecipeComponentsCompanion(')
          ..write('variantId: $variantId, ')
          ..write('inventoryItemId: $inventoryItemId, ')
          ..write('quantityAtomic: $quantityAtomic, ')
          ..write('rowid: $rowid')
...
class $CreditSalesTable extends CreditSales
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CreditSalesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'credit_sales';
  @override
  VerificationContext validateIntegrity(
    Insertable<CreditSaleRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CreditSaleRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CreditSaleRow(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $CreditSalesTable createAlias(String alias) {
    return $CreditSalesTable(attachedDatabase, alias);
  }
}

class CreditSaleRow extends DataClass implements Insertable<CreditSaleRow> {
  /// Unique global ID generated on the device as a UUID
  final String id;
  ...
  CreditSalesCompanion toCompanion(bool nullToAbsent) {
    return CreditSalesCompanion(
      id: Value(id),
      active: Value(active),
      version: Value(version),
      createdEventId: createdEventId == null && nullToAbsent
  ...
  factory CreditSaleRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CreditSaleRow copyWithCompanion(CreditSalesCompanion data) {
    return CreditSaleRow(
      id: data.id.present ? data.id.value : this.id,
      active: data.active.present ? data.active.value : this.active,
      version: data.version.present ? data.version.value : this.version,
  ...
  @override
  String toString() {
    return (StringBuffer('CreditSaleRow(')
          ..write('id: $id, ')
          ..write('active: $active, ')
          ..write('version: $version, ')
          ..write('createdEventId: $createdEventId, ')
...
class CreditSalesCompanion extends UpdateCompanion<CreditSaleRow> {
  final Value<String> id;
  final Value<bool> active;
  final Value<int> version;
  final Value<String?> createdEventId;
  ...
  CreditSalesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       amountMinor = Value(amountMinor),
       occurredAtMs = Value(occurredAtMs);
  static Insertable<CreditSaleRow> custom({
    Expression<String>? id,
    Expression<bool>? active,
    Expression<int>? version,
    Expression<String>? createdEventId,
  ...
  @override
  String toString() {
    return (StringBuffer('CreditSalesCompanion(')
          ..write('id: $id, ')
          ..write('active: $active, ')
          ..write('version: $version, ')
          ..write('createdEventId: $createdEventId, ')
...
class $CreditAllocationsTable extends CreditAllocations
    with TableInfo<$CreditAllocationsTable, CreditAllocation> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CreditAllocationsTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [paymentId, creditId, amountMinor];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'credit_allocations';
  @override
  VerificationContext validateIntegrity(
    Insertable<CreditAllocation> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {paymentId, creditId};
  @override
  CreditAllocation map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $CreditAllocationsTable createAlias(String alias) {
    return $CreditAllocationsTable(attachedDatabase, alias);
  }
}

class CreditAllocation extends DataClass
    implements Insertable<CreditAllocation> {
  ...
  CreditAllocationsCompanion toCompanion(bool nullToAbsent) {
    return CreditAllocationsCompanion(
  ...
  factory CreditAllocation.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CreditAllocation copyWithCompanion(CreditAllocationsCompanion data) {
    return CreditAllocation(
  ...
  @override
  String toString() {
    return (StringBuffer('CreditAllocation(')
  ...
  @override
  int get hashCode => Object.hash(paymentId, creditId, amountMinor);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CreditAllocation &&
          other.paymentId == this.paymentId &&
          other.creditId == this.creditId &&
          other.amountMinor == this.amountMinor);
}

class CreditAllocationsCompanion extends UpdateCompanion<CreditAllocation> {
  final Value<String> paymentId;
  final Value<String> creditId;
  final Value<int> amountMinor;
  final Value<int> rowid;
  const CreditAllocationsCompanion({
  ...
  CreditAllocationsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       creditId = Value(creditId),
       amountMinor = Value(amountMinor);
  static Insertable<CreditAllocation> custom({
  ...
  CreditAllocationsCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('CreditAllocationsCompanion(')
          ..write('paymentId: $paymentId, ')
          ..write('creditId: $creditId, ')
          ..write('amountMinor: $amountMinor, ')
          ..write('rowid: $rowid')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index ixCustomerPaymentsCustomer = Index(
...
final class $$ClientesTableReferences
  ...
  static MultiTypedResultKey<$SalesTable, List<SaleRow>> _salesRefsTable(
    ...
    db.sales,
    aliasName: 'clientes__id__sales__cliente_id',
  );
  ...
  static MultiTypedResultKey<$CreditSalesTable, List<CreditSaleRow>>
  _creditSalesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.creditSales,
    aliasName: 'clientes__id__credit_sales__cliente_id',
  );

  $$CreditSalesTableProcessedTableManager get creditSalesRefs {
    final manager = $$CreditSalesTableTableManager(
      $_db,
      $_db.creditSales,
    ).filter((f) => f.clienteId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_creditSalesRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }

  static MultiTypedResultKey<$CustomerPaymentsTable, List<CustomerPaymentRow>>
  _customerPaymentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.customerPayments,
    aliasName: 'clientes__id__customer_payments__cliente_id',
  );
...
class $$ClientesTableFilterComposer
  ...
  Expression<bool> creditSalesRefs(
    Expression<bool> Function($$CreditSalesTableFilterComposer f) f,
  ) {
    final $$CreditSalesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.creditSales,
      getReferencedColumn: (t) => t.clienteId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$CreditSalesTableFilterComposer(
            $db: $db,
            $table: $db.creditSales,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ClientesTableAnnotationComposer
  ...
  Expression<T> creditSalesRefs<T extends Object>(
    Expression<T> Function($$CreditSalesTableAnnotationComposer a) f,
  ) {
    final $$CreditSalesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.creditSales,
      getReferencedColumn: (t) => t.clienteId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$CreditSalesTableAnnotationComposer(
            $db: $db,
            $table: $db.creditSales,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (creditSalesRefs) db.creditSales,
...
final class $$InventoryItemsTableReferences
  ...
  static MultiTypedResultKey<$RecipeComponentsTable, List<RecipeComponentRow>>
  _recipeComponentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.recipeComponents,
    aliasName: 'inventory_items__id__recipe_components__inventory_item_id',
  );

  $$RecipeComponentsTableProcessedTableManager get recipeComponentsRefs {
    final manager =
        $$RecipeComponentsTableTableManager($_db, $_db.recipeComponents).filter(
          (f) => f.inventoryItemId.id.sqlEquals($_itemColumn<String>('id')!),
        );

    final cache = $_typedResult.readTableOrNull(
      _recipeComponentsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$InventoryItemsTableFilterComposer
  ...
  Expression<bool> recipeComponentsRefs(
    Expression<bool> Function($$RecipeComponentsTableFilterComposer f) f,
  ) {
    final $$RecipeComponentsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.recipeComponents,
      getReferencedColumn: (t) => t.inventoryItemId,
      builder:
          (
            joinBuilder, {
...
class $$InventoryItemsTableAnnotationComposer
  ...
  Expression<T> recipeComponentsRefs<T extends Object>(
    Expression<T> Function($$RecipeComponentsTableAnnotationComposer a) f,
  ) {
    final $$RecipeComponentsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.recipeComponents,
      getReferencedColumn: (t) => t.inventoryItemId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$RecipeComponentsTableAnnotationComposer(
            $db: $db,
            $table: $db.recipeComponents,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
                    ...
                    return [
                      ...
                      if (recipeComponentsRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$InventoryItemsTableReferences
                              ._recipeComponentsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$InventoryItemsTableReferences(
                                db,
                                table,
                                p0,
                              ).recipeComponentsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.inventoryItemId == item.id,
                              ),
...
final class $$ProductVariantsTableReferences
  ...
  _recipeComponentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.recipeComponents,
    aliasName: 'product_variants__id__recipe_components__variant_id',
  );

  $$RecipeComponentsTableProcessedTableManager get recipeComponentsRefs {
    final manager = $$RecipeComponentsTableTableManager(
      $_db,
...
typedef $$RecipeComponentsTableUpdateCompanionBuilder =
    RecipeComponentsCompanion Function({
      Value<String> variantId,
      Value<String> inventoryItemId,
      Value<int> quantityAtomic,
...
final class $$RecipeComponentsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          ...
          RecipeComponentRow
        > {
  $$RecipeComponentsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $ProductVariantsTable _variantIdTable(_$AppDatabase db) => db
      .productVariants
      .createAlias('recipe_components__variant_id__product_variants__id');
  ...
  static $InventoryItemsTable _inventoryItemIdTable(_$AppDatabase db) => db
      .inventoryItems
      .createAlias('recipe_components__inventory_item_id__inventory_items__id');
...
class $$RecipeComponentsTableFilterComposer
    extends Composer<_$AppDatabase, $RecipeComponentsTable> {
  $$RecipeComponentsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnFilters<int> get quantityAtomic => $composableBuilder(
    column: $table.quantityAtomic,
    builder: (column) => ColumnFilters(column),
  );
...
class $$RecipeComponentsTableOrderingComposer
    extends Composer<_$AppDatabase, $RecipeComponentsTable> {
  $$RecipeComponentsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<int> get quantityAtomic => $composableBuilder(
    column: $table.quantityAtomic,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$RecipeComponentsTableAnnotationComposer
    extends Composer<_$AppDatabase, $RecipeComponentsTable> {
  $$RecipeComponentsTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  GeneratedColumn<int> get quantityAtomic => $composableBuilder(
    column: $table.quantityAtomic,
    builder: (column) => column,
  );
...
class $$RecipeComponentsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $RecipeComponentsTable,
          ...
          $$RecipeComponentsTableOrderingComposer,
          $$RecipeComponentsTableAnnotationComposer,
          $$RecipeComponentsTableCreateCompanionBuilder,
          $$RecipeComponentsTableUpdateCompanionBuilder,
  ...
  $$RecipeComponentsTableTableManager(
    _$AppDatabase db,
    $RecipeComponentsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$RecipeComponentsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$RecipeComponentsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$RecipeComponentsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> variantId = const Value.absent(),
                Value<String> inventoryItemId = const Value.absent(),
                Value<int> quantityAtomic = const Value.absent(),
                Value<int> rowid = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$RecipeComponentsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
...
typedef $$RecipeComponentsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $RecipeComponentsTable,
      RecipeComponentRow,
...
final class $$SalesTableReferences
  ...
  static $ClientesTable _clienteIdTable(_$AppDatabase db) =>
      db.clientes.createAlias('sales__cliente_id__clientes__id');
  ...
  _creditSalesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.creditSales,
    aliasName: 'sales__id__credit_sales__sale_id',
  );
...
class $$SaleItemsTableFilterComposer
  ...
  ColumnFilters<int> get standardCostMinorSnapshot => $composableBuilder(
    column: $table.standardCostMinorSnapshot,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get priceReferenceQuantityAtomicSnapshot =>
      $composableBuilder(
        column: $table.priceReferenceQuantityAtomicSnapshot,
        builder: (column) => ColumnFilters(column),
      );
...
class $$SaleItemsTableOrderingComposer
  ...
  ColumnOrderings<int> get standardCostMinorSnapshot => $composableBuilder(
    column: $table.standardCostMinorSnapshot,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get priceReferenceQuantityAtomicSnapshot =>
      $composableBuilder(
        column: $table.priceReferenceQuantityAtomicSnapshot,
        builder: (column) => ColumnOrderings(column),
      );
...
class $$SaleItemsTableAnnotationComposer
  ...
  GeneratedColumn<int> get standardCostMinorSnapshot => $composableBuilder(
    column: $table.standardCostMinorSnapshot,
    builder: (column) => column,
  );

  GeneratedColumn<int> get priceReferenceQuantityAtomicSnapshot =>
      $composableBuilder(
        column: $table.priceReferenceQuantityAtomicSnapshot,
        builder: (column) => column,
      );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                standardCostMinorSnapshot: standardCostMinorSnapshot,
                priceReferenceQuantityAtomicSnapshot:
                    priceReferenceQuantityAtomicSnapshot,
...
typedef $$CreditSalesTableUpdateCompanionBuilder =
    CreditSalesCompanion Function({
      Value<String> id,
      Value<bool> active,
      Value<int> version,
...
final class $$CreditSalesTableReferences
    extends BaseReferences<_$AppDatabase, $CreditSalesTable, CreditSaleRow> {
  $$CreditSalesTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $SalesTable _saleIdTable(_$AppDatabase db) =>
      db.sales.createAlias('credit_sales__sale_id__sales__id');
  ...
  static $ClientesTable _clienteIdTable(_$AppDatabase db) =>
      db.clientes.createAlias('credit_sales__cliente_id__clientes__id');
  ...
  static MultiTypedResultKey<$CreditAllocationsTable, List<CreditAllocation>>
  _creditAllocationsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.creditAllocations,
        aliasName: 'credit_sales__id__credit_allocations__credit_id',
      );

  $$CreditAllocationsTableProcessedTableManager get creditAllocationsRefs {
    final manager = $$CreditAllocationsTableTableManager(
      $_db,
      $_db.creditAllocations,
    ).filter((f) => f.creditId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _creditAllocationsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$CreditSalesTableFilterComposer
    extends Composer<_$AppDatabase, $CreditSalesTable> {
  $$CreditSalesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  Expression<bool> creditAllocationsRefs(
    Expression<bool> Function($$CreditAllocationsTableFilterComposer f) f,
  ) {
    final $$CreditAllocationsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.creditAllocations,
...
class $$CreditSalesTableOrderingComposer
    extends Composer<_$AppDatabase, $CreditSalesTable> {
  $$CreditSalesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CreditSalesTableAnnotationComposer
    extends Composer<_$AppDatabase, $CreditSalesTable> {
  $$CreditSalesTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  Expression<T> creditAllocationsRefs<T extends Object>(
    Expression<T> Function($$CreditAllocationsTableAnnotationComposer a) f,
  ) {
    final $$CreditAllocationsTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.creditAllocations,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$CreditAllocationsTableAnnotationComposer(
                $db: $db,
                $table: $db.creditAllocations,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
...
class $$CreditSalesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CreditSalesTable,
          ...
          $$CreditSalesTableOrderingComposer,
          $$CreditSalesTableAnnotationComposer,
          $$CreditSalesTableCreateCompanionBuilder,
          $$CreditSalesTableUpdateCompanionBuilder,
          (CreditSaleRow, $$CreditSalesTableReferences),
          CreditSaleRow,
          PrefetchHooks Function({
            bool saleId,
            bool clienteId,
        ...
        > {
  $$CreditSalesTableTableManager(_$AppDatabase db, $CreditSalesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CreditSalesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CreditSalesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CreditSalesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<bool> active = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CreditSalesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (creditAllocationsRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$CreditSalesTableReferences
                              ._creditAllocationsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$CreditSalesTableReferences(
                                db,
                                table,
                                p0,
                              ).creditAllocationsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
...
typedef $$CreditSalesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CreditSalesTable,
      CreditSaleRow,
...
final class $$CustomerPaymentsTableReferences
  ...
  static $ClientesTable _clienteIdTable(_$AppDatabase db) =>
      db.clientes.createAlias('customer_payments__cliente_id__clientes__id');
  ...
  _creditAllocationsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.creditAllocations,
        aliasName: 'customer_payments__id__credit_allocations__payment_id',
      );
...
typedef $$CreditAllocationsTableUpdateCompanionBuilder =
    CreditAllocationsCompanion Function({
      Value<String> paymentId,
      Value<String> creditId,
      Value<int> amountMinor,
...
final class $$CreditAllocationsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          ...
          CreditAllocation
        > {
  $$CreditAllocationsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );

  static $CustomerPaymentsTable _paymentIdTable(_$AppDatabase db) => db
      .customerPayments
      .createAlias('credit_allocations__payment_id__customer_payments__id');

  $$CustomerPaymentsTableProcessedTableManager get paymentId {
  ...
  static $CreditSalesTable _creditIdTable(_$AppDatabase db) => db.creditSales
      .createAlias('credit_allocations__credit_id__credit_sales__id');

  $$CreditSalesTableProcessedTableManager get creditId {
...
class $$CreditAllocationsTableFilterComposer
    extends Composer<_$AppDatabase, $CreditAllocationsTable> {
  $$CreditAllocationsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  $$CreditSalesTableFilterComposer get creditId {
    final $$CreditSalesTableFilterComposer composer = $composerBuilder(
      composer: this,
...
class $$CreditAllocationsTableOrderingComposer
    extends Composer<_$AppDatabase, $CreditAllocationsTable> {
  $$CreditAllocationsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  $$CreditSalesTableOrderingComposer get creditId {
    final $$CreditSalesTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.creditId,
      referencedTable: $db.creditSales,
      getReferencedColumn: (t) => t.id,
...
class $$CreditAllocationsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CreditAllocationsTable> {
  $$CreditAllocationsTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  $$CustomerPaymentsTableAnnotationComposer get paymentId {
    final $$CustomerPaymentsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.paymentId,
      referencedTable: $db.customerPayments,
  ...
  $$CreditSalesTableAnnotationComposer get creditId {
    final $$CreditSalesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.creditId,
      referencedTable: $db.creditSales,
...
class $$CreditAllocationsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CreditAllocationsTable,
          ...
          $$CreditAllocationsTableOrderingComposer,
          $$CreditAllocationsTableAnnotationComposer,
          $$CreditAllocationsTableCreateCompanionBuilder,
          $$CreditAllocationsTableUpdateCompanionBuilder,
          (CreditAllocation, $$CreditAllocationsTableReferences),
          CreditAllocation,
          PrefetchHooks Function({bool paymentId, bool creditId})
        > {
  $$CreditAllocationsTableTableManager(
    _$AppDatabase db,
    $CreditAllocationsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CreditAllocationsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CreditAllocationsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CreditAllocationsTableAnnotationComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CreditAllocationsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({paymentId = false, creditId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
typedef $$CreditAllocationsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CreditAllocationsTable,
      CreditAllocation,
